    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Container(
          ...
          child: Text(
"Click on your name to Verify your human identity",            style: TextStyle(color: Colors.white,fontSize: 18),
            maxLines: 2,
            overflow: TextOverflow.ellipsis,
          ),)),
        // title: const Text(
        //   "Please provide your name to undergo the verification process and confirm that you are a human user",
        //   style: TextStyle(color: Colors.white),
        // ),
              toolbarHeight: 100, // Set the desired height for the app bar
